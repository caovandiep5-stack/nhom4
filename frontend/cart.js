...
// ========================================================
// CODE THANH TOÁN: GIỎ HÀNG TRỐNG - LỊCH SỬ GIỮ NGUYÊN
// ========================================================
window.handleCheckout = function() {
    ...
    // 1. LƯU LỊCH SỬ: Cất đơn hàng vào 'orderHistory' trước khi xóa
    const newOrder = {
        orderId: 'DH' + Date.now(),
        items: currentCart,
...
// Tự động gán sự kiện vào nút "Thanh Toán" khi trang sop.html tải xong
document.addEventListener('DOMContentLoaded', function() {
    const checkoutButton = document.querySelector('.btn-success') || document.querySelector('button[class*="ThanhToan"]');
    if (checkoutButton) {
        checkoutButton.addEventListener('click', window.handleCheckout);
    }
});